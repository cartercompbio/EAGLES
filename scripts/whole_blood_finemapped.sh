...
heritability='/cellar/users/domeyer/EAGLE/test_expr/whole_blood_heritability_for_finemap.tsv' #debug with "/cellar/users/domeyer/EAGLE/test_expr/whole_blood_heritability_100.tsv"
