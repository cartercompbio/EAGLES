...
do
    ...
    for mode in flipAllele flipAlleleLDLax flipAlleleLDMed flipAlleleLDStrict pcregression pcregressionLDLax pcregressionLDMed pcregressionLDStrict xgb xgbLDLax xgbLDMed xgbLDStrict
    do
