...
heritability="/cellar/users/domeyer/EAGLE/test_expr/whole_blood_heritability.tsv" #debug with "/cellar/users/domeyer/EAGLE/test_expr/whole_blood_heritability_100.tsv"
...
for mode in elasticnetLDLax flipAlleleLDLax pcregressionLDLax xgbLDLax randomforestLDLax
do
