...
heritability="/cellar/users/domeyer/EAGLE/icb_eqtls/genes.tsv"
...
for eqtl_mode in 218 889
do

    gtexQTLfolder="/cellar/users/domeyer/EAGLE/icb_eqtls/$eqtl_mode"
    gtexQTLindexFolder="/cellar/users/domeyer/EAGLE/icb_eqtls/$eqtl_mode"

    for mode in elasticnetLDStrict flipAlleleLDStrict pcregressionLDStrict xgbLDStrict
    do
        outdir="/cellar/shared/carterlab/projects/eagle/icb_models_blood/$eqtl_mode/$mode"
