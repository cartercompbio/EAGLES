...
modes=(flipAllele pcregression xgb \
        flipAlleleLDLax pcregressionLDLax xgbLDLax \
        flipAlleleLDMed pcregressionLDMed xgbLDMed \
        flipAlleleLDStrict pcregressionLDStrict xgbLDStrict)
