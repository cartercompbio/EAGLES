...
modes=(elasticnetLDMed flipAlleleLDMed pcregressionLDMed xgbLDMed randomforestLDMed elasticnetLDStrict flipAlleleLDStrict pcregressionLDStrict xgbLDStrict randomforestLDStrict)
