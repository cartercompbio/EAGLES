...
modes=(elasticnetLDLax flipAlleleLDLax pcregressionLDLax xgbLDLax randomforestLDLax elasticnet flipAllele pcregression xgb randomforest)

cohort_idx=$(( ($SLURM_ARRAY_TASK_ID - 1) / 10 ))
mode_idx=$(( ($SLURM_ARRAY_TASK_ID - 1) % 10 ))
...
outdir="/cellar/shared/carterlab/projects/eagle/v0.3/whole_blood_finemap/$mode"
