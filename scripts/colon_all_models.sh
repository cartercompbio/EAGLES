...
for mode in elasticnetLDLax elasticnetLDMed elasticnetLDStrict flipAlleleLDLax flipAlleleLDMed flipAlleleLDStrict pcregressionLDLax pcregressionLDMed pcregressionLDStrict xgbLDLax xgbLDMed xgbLDStrict randomforestLDLax randomforestLDMed randomforestLDStrict
do
    outdir="/cellar/shared/carterlab/projects/eagle/v0.3/colon/$mode"
...
for mode in elasticnetLDLax elasticnet flipAlleleLDLax flipAllele pcregressionLDLax pcregression xgbLDLax xgb randomforestLDLax randomforest
do
    outdir="/cellar/shared/carterlab/projects/eagle/v0.3/colon_finemapped/$mode"
